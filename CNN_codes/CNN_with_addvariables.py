...
def CNNM(input_x, input_y,input_variables,
          img_len=164, channel_num=4, output_size=2,
...
def cnnm_training(X_train, y_train, X_trainvar,X_val, y_val,X_valvar,
             addedvar_num=5000,
    ...
    output,loss=CNNM(xs,ys,xvar,img_len=imglen, channel_num=4, output_size=2,conv_featmap=conv_featmap,fc_units=fc_units,conv_kernel_size=[5, 5], pooling_size=[2,2],l2_norm=l2_norm, seed=seed)
    ...
    iter_total = 0
    best_acc = 0
    cur_model_name = 'cnnm_{}'.format(int(time.time()))
