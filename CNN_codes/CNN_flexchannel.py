...
def cnn_training(X_train, y_train, X_val, y_val, 
    ...
    output,loss=CNN(xs,ys,img_len=imglen, channel_num=channum, output_size=2,conv_featmap=conv_featmap,fc_units=fc_units,conv_kernel_size=[3,3], pooling_size=[2,2],l2_norm=l2_norm, seed=seed)
            ...
            for itr in range(iters):
                ...
                if itr == iters-1:
                    ...
                    if valid_acc > best_acc:
                        ...
                        #getActivations(conv_layer_0,training_batch_x[0,:,:,0])
